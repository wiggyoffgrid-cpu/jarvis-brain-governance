---
# D-00 — Jarvis Brain Domain Structure
**Version:** 1.0
**Status:** Active
**Created:** April 3, 2026
**Updated:** April 5, 2026 — D-43 location corrected to current path; D-10 subfolder count updated (post-Neurologist audit)
...
Nothing in the Jarvis Brain stands alone. Every file belongs to a domain. Every domain connects through the D-Series Compass. If a file has no domain, it has no home — and homeless files are how systems rot.
...
**TIER 2 — WIGGY AUTHORITY, AI ASSISTS (Business Critical)**
AI can draft, organize, and prepare — but Wiggy reviews and approves before anything is committed. Sensitive business data lives here.

**TIER 3 — AI OPERATIONAL (AI builds, Wiggy approves)**
AI workers can build, maintain, and update these domains. Wiggy audits periodically. Standard operational data.

**TIER 4 — SYSTEM (AI managed, Wiggy audits)**
...
**D-10 People & Family**
Wiggy's family tree, relationships, personal contacts. 76 XML people cards across 15+ subfolders (inlaws split into 4 subfolders April 3, 2026). Only Wiggy dictates family data. No AI writes, infers, or modifies relationship information.
...
**D-12 Clients & CRM**
APE Canada clients — companies and individuals with ongoing equipment relationships managed by Wiggy. Tailored quotes, negotiated pricing, project-based engagement. 309 client XML cards across 113 company folders. Card format: <CLIENT> standard 11-field template.
...
Location: TBD — requires Navision access governance
...
**D-20 APE Equipment**
APE product line — vibro hammers, impact hammers, drill systems, wick drains. Product XMLs, specifications, manuals, WEAP data, technical documentation. Equipment that APE sells and rents to clients.
...
APE's own operational equipment — cranes, forklifts, yard equipment. Not products for sale — equipment APE uses internally.
Location: TBD — not yet built
...
Building repairs, HVAC, electrical, plumbing — the physical APE Nisku facility.
Location: TBD — not yet built
...
Location: D:\Jarvis\brain\governance\ and D:\Jarvis\brain\governance\D-Series\
...
- Numbers are PERMANENT once assigned — never reuse, never insert between existing numbers
...
## Purpose (Refined)
Nothing in the Jarvis Brain stands alone. Every file belongs to a domain, and every domain connects through the D-Series Compass — so any AI worker can move from "what do I have" to "where does it go" and from "what's broken" to "what fixes it", without guesswork.
